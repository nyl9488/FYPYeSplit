 ...
 ImageView imageView;
   ...
   // Button btnSelect;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = (ImageView)this.findViewById(R.id.editbill_billimage);
        View getNImages = findViewById(R.id.get_edbill_images);
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(EditBill.this);
