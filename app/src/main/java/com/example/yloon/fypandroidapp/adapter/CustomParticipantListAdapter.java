...
public class CustomParticipantListAdapter extends ArrayAdapter<Participant> {
    Context context;
    ArrayList<Participant> result;
    public CustomParticipantListAdapter(Context context1, ArrayList<Participant> payers) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        Participant payer = getItem(position);
